...
#define PAYLOAD_TYPE_GRP_TXT \
  0x05 // an (unverified) group text message (prefixed with channel hash, MAC) (enc data: timestamp, "name:
       // msg")
#define PAYLOAD_TYPE_GRP_DATA \
  0x06 // an (unverified) group datagram (prefixed with channel hash, MAC) (enc data: timestamp, blob)
#define PAYLOAD_TYPE_ANON_REQ \
...
//...
#define PAYLOAD_TYPE_RAW_CUSTOM \
