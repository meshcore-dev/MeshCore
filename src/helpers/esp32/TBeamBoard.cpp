...
//         LORA_TX_POWER, 8); if (status != RADIOLIB_ERR_NONE) {
...
//         int status1 = radio.begin(LORA_FREQ, LORA_BW, LORA_SF, LORA_CR, RADIOLIB_SX126X_SYNC_WORD_PRIVATE,
//         LORA_TX_POWER, 8); if (status1 != RADIOLIB_ERR_NONE) {
