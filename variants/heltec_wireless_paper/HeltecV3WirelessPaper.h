...
class HeltecV3WirelessPaper : public ESP32Board {
private:
...
public:
  ...
  HeltecV3WirelessPaper() : periph_power(PIN_VEXT_EN) { }
  ...
  uint16_t getBattMilliVolts() override {
    ...
    MESH_DEBUG_PRINT("ADC CTRL pin set to active state %d\n", adc_active_state);
    ...
    digitalWrite(PIN_ADC_CTRL, !adc_active_state);
    uint32_t voltage = (0.842 * (4.2 / 1024.0) * raw) * 1000;
