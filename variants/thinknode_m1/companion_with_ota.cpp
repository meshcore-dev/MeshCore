// Thinknode M1 Companion with OTA Trigger
// This is the standard BLE companion firmware with added OTA trigger capability
// Press the dedicated OTA button (PIN_OTA_BTN) to enter BLE DFU mode
