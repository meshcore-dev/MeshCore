...
// This is used as an *output* from the sx1262 and connected internally to power the tcxo, do not drive from
// the main CPU?
...
#define PIN_GPS_STANDBY \
  (0 + 13) // An output to wake GPS, low means allow sleep, high means force wake STANDBY
