...
#define BATTERY_PIN \
  35 // A battery voltage measurement pin, voltage divider connected here to measure battery voltage
#define ADC_CHANNEL    ADC1_GPIO35_CHANNEL
#define ADC_MULTIPLIER 2
#define EXT_PWR_DETECT \
  4 // Pin to detect connected external power source for LILYGO® TTGO T-Energy T18 and other DIY boards
...
#define SX126X_MAX_POWER \
  22 // Outputting 22dBm from SX1262 results in ~30dBm E22-900M30S output (module only uses last stage of the
     // YP2233W PA)
...
// The E22's TXEN pin is connected to MCU pin, E22's RXEN pin is connected to MCU pin (allows for ramping up
// PA before transmission Don't define DIO2_AS_RF_SWITCH because we only use DIO2 or an MCU pin mutually
// exclusively to connect to E22's TXEN (to prevent a short if they are both connected at the same time and
// there's a slight non-neglibible delay and/or voltage difference between DIO2 and TXEN).
