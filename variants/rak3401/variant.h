...
// IO2 is hooked to GPS RESET = gpio 34, but it can not be used to this because IO2 is ALSO used to control
// 3V3_S power (1 is on). Therefore must be 1 to keep peripherals powered Power is on the controllable 3V3_S
// rail
