...
// Solar current from BQ25798 IBUS ADC has significant error at low currents (~±30mA).
...
typedef enum {
  ...
  BQ25798_CHARGER_STATE_UNKNOWN = 0xFF  // I2C read failed — status unavailable
...
// Extended BQ25798 driver with NTC support and comprehensive telemetry.
