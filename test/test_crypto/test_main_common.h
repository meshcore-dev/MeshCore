...
extern void test_AsconRNG_benchmark_entropy_vs_prng(void);
extern void test_AsconRNG_deterministic_for_same_seed(void);
extern void test_AsconRNG_stream_advances_between_calls(void);
extern void test_AsconRNG_reseed_changes_stream(void);
extern void test_AsconRNG_reseed_deterministic_for_equal_inputs(void);
...
inline void run_all_tests(void) {
  ...
  RUN_TEST(test_AsconRNG_benchmark_entropy_vs_prng);
  RUN_TEST(test_AsconRNG_deterministic_for_same_seed);
  RUN_TEST(test_AsconRNG_stream_advances_between_calls);
  RUN_TEST(test_AsconRNG_reseed_changes_stream);
  RUN_TEST(test_AsconRNG_reseed_deterministic_for_equal_inputs);
}
