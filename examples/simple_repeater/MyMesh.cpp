...
#endif
{
  ...
  _prefs.rx_delay_base = 3.0f;   // off by default, was 10.0, was 0.0
  _prefs.tx_delay_factor = 1.6f; // was 0.25f, was 0.5f
  _prefs.direct_tx_delay_factor = 1.0f; // was zero, was 0.3
