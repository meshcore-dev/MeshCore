...
**A:** Yes. Firmwares, Client software, web services, software libraries, command line tools, data collectors, forums, wikis, &hellip;

Due to their amount we do not track them anymore here, but list some external ressources which track some of them.

See for example:

* https://github.com/samuk/awesome-meshcore,
* [#software-development channel on MeshCore Discord space](https://discord.com/channels/1343693475589263471/1350224495633371219),
* &hellip;
